        ...
        <nav className="header">
            ...
            <div className="header__nav">
               ...
               {/* Basket Shopping Cart */}
                ...
                {/* Shopping cart icon with a number */}
